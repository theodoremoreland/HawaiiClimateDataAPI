...
measurement_columns = inspector.get_columns('measurement') #id(int), station(txt), date(txt), prcp(flt), tobs(flt)
station_columns = inspector.get_columns('station') #id(int), station(txt), name(txt), latitude(flt), longitude(flt), elevation(flt)
